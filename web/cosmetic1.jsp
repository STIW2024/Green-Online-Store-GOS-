<%-- 
    Document   : cosmetic1
    Created on : Dec 17, 2017, 11:06:35 PM
    Author     : JARD
--%>
...
<html>
    ...
    <div id="wrapper">
        <div id="top">
            <div><font size="20"><font color="white">Cleansing Form</div>
            <div>we are providing a 100% organic cosmetic</div>
            <p></p>
            <body>
            <center>
                <div>
                    <img src="ogcos1.jpg" alt="" width="450" height="500" position="left" align="top"/><a> <font size="6">
                    </a>  
