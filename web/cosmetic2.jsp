<%-- 
    Document   : cosmetic2
    Created on : Dec 17, 2017, 11:06:47 PM
    Author     : JARD
--%>
...
<html>
   ...
   <style type="text/css">
        ...
        <div id="wrapper">
        <div id="top">
            <div><font size="20"><font color="white">Creamy Cleanser</div>
            <div>we are providing a 100% organic cosmetic</div>
            <p></p>
         <body>
         <center>
              <div>
                  <img src="ogcos2.png" alt="" width="450" height="500" position="left" align="top"/><a> <font size="6">
                      </a>  
